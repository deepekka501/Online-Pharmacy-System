  ...
  if ($_FILES["image"]["error"]===4) {
    ...
    if(!in_array($imageExtension,$validImageExtension)){
      ...
      $query="INSERT INTO medicine VALUES(Null,'$medicine','$manufacturing_date','$newImageName','$desc','$c_id','$price','$exp_date','$qty')";
        // $query="UPDATE `medicine` SET `medicine` = 'Ibuprofe', `manufacturing_date` = '2024-05-07', `image` = '6648692ee7777.jpeg', `price` = '56', `expiry_date` = '2024-05-30', `quantity` = '101' WHERE `medicine`.`id` = 18;";
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i>Update Medicines</div>
        <div class="card-body">
