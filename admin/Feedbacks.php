...
<?php
      $sqlgetCate = "SELECT * FROM  feedbacks join user on feedbacks.u_id=user.id; ";
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i>Feedbacks</div>
        <div class="card-body">
        ...
        <?php
                    if ($resgetCate->num_rows > 0) {
                        ...
                        while($rowgetCate = $resgetCate->fetch_assoc()){
                          echo "<tr >  
                          <form method='POST' action='feedbackreply.php'>
                                    <td class='text-center align-middle'>" . $rowgetCate["feedback_id"]. "</td>
                                   
                                    <input type='hidden' class='btn btn-primary' name='feed_id' value='" . $rowgetCate["feedback_id"]. "'>
                                    
                                    <td class='text-center align-middle'>" . $rowgetCate["message"]. "</td>

                                    <td class='text-center align-middle'>" . $rowgetCate["reply"]. "</td>
