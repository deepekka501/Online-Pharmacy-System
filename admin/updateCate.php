...
$getdata="select * from category where category_id='$category_id'";
// $getresult=mysqli_query($con,$getdata);
$resgetCate = $con->query($getdata);
...
$sql="UPDATE `category` SET `category` = '$category', `description` = '$desc' WHERE `category`.`category_id` = $cate_id;";
    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-area-chart"></i> Update Category</div>
        <div class="card-body">
            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <form action="addcategory.php" method="POST">
                  ...
                  <?php echo '
                  <input type="hidden" id="category_id" value='.$rowgetCate['category_id'].' name="category_id" class="form-control" placeholder="description" required/>
                  <input type="text" id="category" value='.$rowgetCate['category'].' name="category" class="form-control" placeholder="category" value="" required/>
                  ...
                  <div class="form-outline mb-2">
                  <?php echo '
                 <input type="text" id="description" value='.$rowgetCate['description'].' name="description" class="form-control" placeholder="description" required/>
